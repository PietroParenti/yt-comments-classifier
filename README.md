...
Once this step is completed, we return to Python to implement more computationally intensive models. First, I built a neural network model, then I used gridsearch to automatically identify the optimal machine learning pipeline for the classification task.
